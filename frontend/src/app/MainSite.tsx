      ...
      <section id="practice" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-[#0F0F0F] to-[#0A0A0A] relative overflow-hidden z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-[#D4AF37]/20 transition-colors duration-200 md:pl-6 md:border-l md:border-l-[#D4AF37]/25">
              <div className="p-6 sm:p-8 lg:p-10 space-y-6 border-b border-white/5">
                <div className="w-14 h-14 bg-gradient-to-br from-[#D4AF37]/20 to-[#D4AF37]/5 rounded-xl flex items-center justify-center transition-all border border-[#D4AF37]/30">
            ...
            <div className="group bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-[#D4AF37]/20 transition-colors duration-200 lg:pl-6 lg:border-l lg:border-l-[#D4AF37]/25">
              <div className="p-6 sm:p-8 lg:p-10 space-y-6 border-b border-white/5">
                <div className="w-14 h-14 bg-gradient-to-br from-[#D4AF37]/20 to-[#D4AF37]/5 rounded-xl flex items-center justify-center transition-all border border-[#D4AF37]/30">
